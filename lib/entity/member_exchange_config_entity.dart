...
class MemberExchangeConfigEntity {
  ...
  factory MemberExchangeConfigEntity.fromJson(Map<String, dynamic> json) =>
      $MemberExchangeConfigEntityFromJson(json);
...
class MemberExchangeConfigData {
  ...
  factory MemberExchangeConfigData.fromJson(Map<String, dynamic> json) =>
      $MemberExchangeConfigDataFromJson(json);
...
class MemberExchangeConfigDataList {
  ...
  factory MemberExchangeConfigDataList.fromJson(Map<String, dynamic> json) =>
      $MemberExchangeConfigDataListFromJson(json);
...
class MemberExchangeConfigDataPagination {
  ...
  factory MemberExchangeConfigDataPagination.fromJson(
    Map<String, dynamic> json,
  ) => $MemberExchangeConfigDataPaginationFromJson(json);

  Map<String, dynamic> toJson() =>
      $MemberExchangeConfigDataPaginationToJson(this);

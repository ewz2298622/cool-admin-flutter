...
class DictDataEntity {
	...
	factory DictDataEntity.fromJson(Map<String, dynamic> json) => $DictDataEntityFromJson(json);
...
class DictDataData {
	...
	factory DictDataData.fromJson(Map<String, dynamic> json) => $DictDataDataFromJson(json);
...
class DictDataDataLiveCategory {
	...
	factory DictDataDataLiveCategory.fromJson(Map<String, dynamic> json) => $DictDataDataLiveCategoryFromJson(json);
...
class DictDataDataLiveTags {
	...
	factory DictDataDataLiveTags.fromJson(Map<String, dynamic> json) => $DictDataDataLiveTagsFromJson(json);
...
class DictDataDataWeek {
	...
	factory DictDataDataWeek.fromJson(Map<String, dynamic> json) => $DictDataDataWeekFromJson(json);
...
class DictDataDataArea {
	...
	factory DictDataDataArea.fromJson(Map<String, dynamic> json) => $DictDataDataAreaFromJson(json);
...
class DictDataDataLanguage {
	...
	factory DictDataDataLanguage.fromJson(Map<String, dynamic> json) => $DictDataDataLanguageFromJson(json);
...
class DictDataDataVideoCategory {
	...
	factory DictDataDataVideoCategory.fromJson(Map<String, dynamic> json) => $DictDataDataVideoCategoryFromJson(json);
...
class DictDataDataNoticeType {
	...
	factory DictDataDataNoticeType.fromJson(Map<String, dynamic> json) => $DictDataDataNoticeTypeFromJson(json);
...
class DictDataDataFeedbackType {
	...
	factory DictDataDataFeedbackType.fromJson(Map<String, dynamic> json) => $DictDataDataFeedbackTypeFromJson(json);
...
class DictDataDataAdsType {
	...
	factory DictDataDataAdsType.fromJson(Map<String, dynamic> json) => $DictDataDataAdsTypeFromJson(json);
...
class DictDataDataSearchType {
	...
	factory DictDataDataSearchType.fromJson(Map<String, dynamic> json) => $DictDataDataSearchTypeFromJson(json);
...
class DictDataDataVideoTag {
	...
	factory DictDataDataVideoTag.fromJson(Map<String, dynamic> json) => $DictDataDataVideoTagFromJson(json);

...
class VideoDetailDataEntity {
  ...
  factory VideoDetailDataEntity.fromJson(Map<String, dynamic> json) =>
      $VideoDetailDataEntityFromJson(json);
...
class VideoDetailDataData {
  ...
  factory VideoDetailDataData.fromJson(Map<String, dynamic> json) =>
      $VideoDetailDataDataFromJson(json);
...
class VideoDetailDataDataVideo {
  ...
  factory VideoDetailDataDataVideo.fromJson(Map<String, dynamic> json) =>
      $VideoDetailDataDataVideoFromJson(json);
...
class VideoDetailDataDataLines {
  ...
  factory VideoDetailDataDataLines.fromJson(Map<String, dynamic> json) =>
      $VideoDetailDataDataLinesFromJson(json);
...
class VideoDetailDataDataLinesPlayLines {
  ...
  factory VideoDetailDataDataLinesPlayLines.fromJson(
    Map<String, dynamic> json,
  ) => $VideoDetailDataDataLinesPlayLinesFromJson(json);

  Map<String, dynamic> toJson() =>
      $VideoDetailDataDataLinesPlayLinesToJson(this);

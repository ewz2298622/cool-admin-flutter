...
class NoticeInfoEntity {
	...
	factory NoticeInfoEntity.fromJson(Map<String, dynamic> json) => $NoticeInfoEntityFromJson(json);
...
class NoticeInfoData {
	...
	factory NoticeInfoData.fromJson(Map<String, dynamic> json) => $NoticeInfoDataFromJson(json);
...
class NoticeInfoDataList {
	...
	factory NoticeInfoDataList.fromJson(Map<String, dynamic> json) => $NoticeInfoDataListFromJson(json);
...
class NoticeInfoDataPagination {
	...
	factory NoticeInfoDataPagination.fromJson(Map<String, dynamic> json) => $NoticeInfoDataPaginationFromJson(json);
